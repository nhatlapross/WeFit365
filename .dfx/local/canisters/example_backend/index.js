...
import { idlFactory } from './example_backend.did.js';
export { idlFactory } from './example_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EXAMPLE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./example_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the example_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./example_backend.did.js")._SERVICE>}
 */
export const example_backend = createActor(canisterId);
