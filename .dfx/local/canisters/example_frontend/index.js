...
import { idlFactory } from './example_frontend.did.js';
export { idlFactory } from './example_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_EXAMPLE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./example_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the example_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./example_frontend.did.js")._SERVICE>}
 */
export const example_frontend = createActor(canisterId);
