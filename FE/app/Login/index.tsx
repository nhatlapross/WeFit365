  ...
  return (
    <div className="p-6 rounded-lg max-w-sm mx-auto">
      ...
      <div className="mt-5 mb-5">
        <Button className="w-full bg-primary text-white" >Log in</Button>
      </div>
      ...
      <div className="flex flex-row mb-5">
        <Button startContent={<GoogleIcon />} size="md" className="button flex-1 mx-1">Google</Button>
        <Button startContent={<FacebookIcon />} size="md" className="button flex-1 mx-1">Facebook</Button>
      </div>
